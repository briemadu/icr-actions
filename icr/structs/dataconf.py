...
# number of cliparts shown in the gallery
SIZE_GALLERY: int = 28
...
HATS = ['blue hat star', 'chef hat', 'pirate hat', 'red gray bonnet',
        'rainbow hat helix', 'witch hat', 'viking helmet']
BALLS = ['baseball', 'ball', 'basketball', 'soccer ball', 'tennis ball', 'football']
CLOUDS = ['cloud', 'cloud lightning', 'cloud rain']
GLASSES = ['glasses', 'sunglasses']
TREES = ['tree', 'pine tree', 'apple tree']
...
file2obj: Dict[str, str] = {
    ...
    # clothing
    'c_0s.png': 'blue hat star',
    'c_1s.png': 'crown',
    'c_2s.png': 'chef hat',
    'c_3s.png': 'pirate hat',
    'c_4s.png': 'red gray bonnet',
    'c_5s.png': 'rainbow hat helix',
    'c_6s.png': 'witch hat',
